...
def valid_move(s,a,s_prime):
    ...
    down_check = check_bounds(s_prime,  (s_prime[0] - 1, s_prime[1]))
    right_check = check_bounds(s_prime,  (s_prime[0], s_prime[1] + 1))
    left_check = check_bounds(s_prime,  (s_prime[0] - 1, s_prime[1] - 1))
    if a == "up":
